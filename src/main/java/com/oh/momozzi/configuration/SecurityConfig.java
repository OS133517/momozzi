...
import com.oh.momozzi.jwt.JwtAccessDeniedHandler;
import com.oh.momozzi.jwt.JwtAuthenticationEntryPoint;
import com.oh.momozzi.jwt.TokenProvider;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/auth/**").permitAll()// 로그인, 회원가입 api 는 토큰이 없는 상태에서 요청이 들어오기 때문에 permial all
